  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.error) {
        ...
        // Save user info to DynamoDB on sign up
        if (!isLogin && result.user) {
          try {
            await saveUserRecoveryPath({
              ...
              recoveryPath: null, // Will be set during onboarding
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      if (result.error) {
        ...
        // Save user info to DynamoDB if new user
        ...
        <div className="card">
          <form onSubmit={handleSubmit} className="space-y-6">
            {!isLogin && (
              <div>
                ...
                <input
                  ...
                  placeholder="Enter your first and last name, or an alias."
                />
              </div>
            )}
            ...
            <div>
              ...
              <input
                ...
                required
                className="input-field"
                placeholder="Enter your password with at least 6 characters."
                minLength={6}
              />
            </div>
          ...
          <div className="mt-6">
            ...
            <button
              ...
              disabled={loading}
              className="mt-4 w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-300 text-gray-700 font-semibold py-3 px-6 rounded-lg transition-all duration-200 hover:bg-gray-50 hover:border-gray-400 shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
            >
