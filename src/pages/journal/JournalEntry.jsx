              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <DatePicker
                    selected={entry.date}
                    onChange={(date) =>
                      setEntry({ ...entry, date: date || new Date() })
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setEntry({
                        ...entry,
                        cravingIntensity: parseInt(e.target.value),
                      })
                    }
                    className="w-full"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setEntry({ ...entry, triggers: e.target.value })
                    }
