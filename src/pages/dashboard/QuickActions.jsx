    ...
    <div className="space-y-3">
      ...
      >
        ...
        <InfoIcon
          ...
          data-tooltip-id="recovery-tracking-tooltip"
          data-tooltip-content="Track your timeline in recovery for substances, behaviors, or anything else you are recovering from."
        />
      ...
      >
        ...
        <InfoIcon
          className="w-4 h-4 absolute right-5"
          data-tooltip-id="write-journal-entry-tooltip"
          data-tooltip-content="Journal your thoughts, feelings, and experiences related to your recovery journey."
        />
      ...
      >
        ...
        <InfoIcon
          className="w-4 h-4 absolute right-5"
          data-tooltip-id="begin-step-work-tooltip"
          data-tooltip-content="Track your recovery journey through working the steps that apply based on your recovery path."
        />
