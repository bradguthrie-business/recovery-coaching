      ...
      {loadingUserData ? (
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="card mb-8">
            ...
            <div className="flex items-center gap-4">
              <p className="text-gray-600">
                Your recovery path:{" "}
                <span className="font-semibold text-recovery-DEFAULT">
                  {RECOVERY_LABELS[userData?.recoveryPath] ||
                    userData?.recoveryPath ||
                    "Not selected"}
                </span>
              </p>
              <button
                onClick={() =>
                  navigate("/onboarding", {
                    state: { recoveryPath: userData?.recoveryPath },
                  })
                } // lets pass in current recovery path to the onboarding page
          ...
          <div className="card mt-8">
            ...
            <p className="text-gray-600">
              Analytics for your recovery journey. These are currently
              randomized and using mock data.
            </p>
            {/* Streak Heatmap, currently randomized and using mock data */}
            <div className="mt-8">
              <StreakHeatmap loading={loadingUserStats} />
            </div>
          </div>
        </main>
      )}
