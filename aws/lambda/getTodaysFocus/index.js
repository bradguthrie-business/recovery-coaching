...
const buildFallbackFocus = (recoveryPath, recentEntries) => {
  const focusTemplates = {
    ...
    celebrate: {
      ...
      suggestions: [
        "Take 5 minutes for quiet prayer",
        "Read a scripture that encourages you",
        "Reach out to someone from your group",
      ],
    },
    ...
    smart: {
      ...
      suggestions: [
        ...
        "Practice an urge management tool",
        "Track a positive behavior today",
      ],
    },
    ...
    mat: {
      ...
      suggestions: [
        ...
        "Reflect on what stability means to you",
        "Take medications on schedule and without shame",
      ],
    },
    ...
    "cali-sober": {
      ...
      suggestions: [
        ...
        "Do one activity completely sober and present",
        "Jot down one boundary that keeps you safe",
      ],
    },
    ...
    psychedelic: {
      ...
      suggestions: [
        "Journal a recent insight",
        "Practice grounding or meditation",
        "Choose one small action aligned with your intentions",
      ],
    },
    ...
    "harm-reduction": {
      ...
      suggestions: [
        "Identify one high-risk situation to avoid",
        "Check in with your emotional state",
        "Reach out to someone who supports your goals",
      ],
    },
    ...
    abstinence: {
      ...
      suggestions: [
        "Reflect on one benefit of staying sober",
        "Practice an urge-surfing technique",
        "Spend time in a healthy routine you enjoy",
      ],
    },
    ...
    "not-sure": {
      ...
      suggestions: [
        "Learn about one recovery approach",
        "Ask yourself what you truly want healing from",
  ...
  if (recentEntries && recentEntries.length > 0) {
    ...
    if (lastEntry.mood === "struggling" || lastEntry.cravingIntensity > 7) {
      template.content +=
        " You have been facing some challenges recently. Remember to reach out for support and use your coping strategies.";
    }
  }
  ...
  try {
    ...
    if (process.env.OPENAI_API_KEY) {
      try {
        ...
        Make content 2 to 3 sentences, compassionate, practical, and specific to the path.
